...
from Wide&Deep import WideDeep

import warnings
warnings.filterwarnings('ignore')


train_set = pd.read_csv('preprocess_data/train_set.csv')
val_set = pd.read_csv('preprocess_data/val_set.csv')
test_set = pd.read_csv('preprocess_data/test.csv')
...
fea_cols = np.load('data/feat_col.npy', allow_pickle=True)
...
dnn_dropout = 0.
net = WideDeep(fea_cols, hidden_units, dnn_dropout)
